...
3. Drop the ZIP file directly into the datapacks folder.

4. Start the world (or run /reload on a server).
...
Most textures and models used in this datapack are from an outdated [Christmas datapack](https://www.planetminecraft.com/data-pack/christmas-decorations-for-minecraft/) by [BronGhast014](https://bronghast014.github.io/home.html).
