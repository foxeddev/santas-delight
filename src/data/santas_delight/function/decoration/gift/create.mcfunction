...
summon item_display ~ ~ ~ {Tags:["santas_delight.decoration.gift.display","new"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0.5f,0f],scale:[1f,1f,1f]},item:{id:"minecraft:stick",count:1}}
